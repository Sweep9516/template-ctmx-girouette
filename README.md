...
As originally generated, it will produce a new library project when run:
    ...
    $ clojure -Sdeps '{:deps {net.clojars.dtou/template-ctmx-girouette {:local/root "."}}}' -Tnew create :template dtou/template-ctmx-girouette :name myusername/mycoollib
...
Your library will be deployed to net.clojars.dtou/template-ctmx-girouette on clojars.org by default.
